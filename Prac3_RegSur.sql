...
----SCRIPT SERVIDORES VINCULADOS REGION SUR: 192.168.229.4
...
--C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\P3_servVin_Part.mdf  --tipo ROW


alter database P3_servVin_Part add file
(
	name= [PartSur],
	filename = 'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\PartSur.ndf',
	size = 3072 KB,	
	maxsize=unlimited,
	filegrowth = 1024 KB
)to filegroup [sur]
